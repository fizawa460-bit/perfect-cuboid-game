#!/usr/bin/env python3
"""Build and verify the repaired Stage14 R03 self-contained review bundle."""
...
BUNDLE = Path("review/STAGE14-FINAL-SELF-CONTAINED-20260812-R03.html")
MANIFEST = Path("docs/review/stage14-final-self-contained-manifest-20260812-r03.md")
...
def build_manifest(content_sha: str, source_sha: str, ledger_sha: str) -> str:
    return f"""# Stage14 final self-contained R03 manifest
