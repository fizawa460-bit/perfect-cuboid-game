...
FINAL_MD = Path("docs/stage12-n1-2-final-r06-zero-base.md")
FINAL_HTML = Path("review/PC-N1-2-FINAL-ZERO-BASE-REREVIEW-20260807-R07.html")
...
def build_markdown(sources: list[tuple[Source, str, str]]) -> str:
    preamble = f"""# Stage12-N1-2 Final R06 — physically self-contained zero-base proof bundle
...
<h1>Stage12-N1-2 Final R06 — physical zero-base review page R07</h1>
<p>This page contains the complete consolidated Markdown, including the historical derivation sources and their supersession rules.</p>
