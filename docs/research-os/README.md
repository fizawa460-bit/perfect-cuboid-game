...
- [`policies/research-credit-and-promotion-firewalls.md`](policies/research-credit-and-promotion-firewalls.md) — **mandatory repo-wide research-credit policy** distilled from repeated Stage16-33 controller/audit failures: finite evidence is not a global theorem, credit layers stay separate, semantic/field/model transfers require adapters, double charge and unsupported independence are forbidden, effectivity is separate, only audited closed dependencies release downstream credit, and hostile audit may reopen prior credit.
