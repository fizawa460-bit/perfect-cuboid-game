...
- [`../stage32-arsenal-promotion.md`](../stage32-arsenal-promotion.md) — provisional Stage32 exact-enumeration compression, rank/unrank, Picard slice/image, finite integral-coset reduction, and exact finite-group equivariant reconstruction cards (`S32-PW01..PW05`).
- [`../stage32-arsenal-proof-adapters-certificates-firewall.md`](../stage32-arsenal-proof-adapters-certificates-firewall.md) — targeted Stage32 proof-adapter/certificate/firewall catch-up. It adds only `S32-PW05`; numerical-candidate→exact-replay and source-locked adapter-wall patterns are Workflow candidates, while concrete fixed-class `K_c` data remain Stage32-specific and non-promoted.
- [`../stage33-arsenal-promotion.md`](../stage33-arsenal-promotion.md) — provisional Stage33 arithmetic-HS zero-survival, Smith/Bockstein finite-module reductions, Picard/Kummer source-target adapters, exact absolute-H1 receiver construction, and geometric Brauer↔translation-torsor↔integral-kernel adapter. Active Stage33 source locks always override historical concrete payloads in this file.
...
- [`../stage33-arsenal-other-reuse-workflow-dedup.md`](../stage33-arsenal-other-reuse-workflow-dedup.md) — final Stage33 catch-all/dedup supplement. It integrates cross-basis marked Picard transport and unique lattice-fingerprint semantic orientation into method-level `PW04`, finite-group equivariance/relabeling diagnostics into `PW05`, literal Čech representative/divisor validation into `PW07`, and adds only `SPARSE_SOURCE_REPLAY` as a new workflow candidate. **Live override:** the historical Picard-adjoint mask-6 coordinate is reopened and must not be used as the named J2 proper-Br2 source until the marked discriminant→proper-Br2 adapter is source-locked. Stage33 remains at eight cards.
