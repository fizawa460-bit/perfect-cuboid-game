...
def main():
    ...
    accepted = {
        ...
        "DISC-S36-B08->S31-W01": {
            ...
            "repo": repo(1624, "6ede28751914a881a5ddaca7691538a8a3e4780c", "stages/stage36/36-09J/reciprocal-involution-two-linear-cover-preflight.json", "72e9ca86f726f2ff286c983138d9381acdd97e62", "stages/stage36/verify_stage36_36_09J.py", "successive cover branch/discriminant data -> genus/degeneration preflight -> S31-W01 routing"),
        ...
        "DISC-S36-B12->S34-W02": {
            ...
            "repo": repo(1655, "f48184e2ab7fabe6fd07b553aa1cda507874569d", "stages/stage36/36-09R/etau-rankjump-receiver-esigmatau-growth-preflight.json", "b55d042ede01032ff8c8b0d872510a53cb857969", "stages/stage36/verify_stage36_36_09R.py", "generic subgroup receiver test -> typed rank/saturation/torsion growth obligation; theorem context only after hypothesis adapter"),
