...
| Finite census/regression/enumerator assets | [`../stage14-num-reuse-index.md`](../stage14-num-reuse-index.md) | `NUM-R*` finite-evidence assets and exact population adapters |
| Prior Stage14/15 route attempts | [`../stage14-15-bound-attack-map.md`](../stage14-15-bound-attack-map.md) | Historical attack map for duplication/failure checks |
| Old blocked/near-miss route clusters | [`../stage14-15-bound-deep-review-queue.md`](../stage14-15-bound-deep-review-queue.md) | Curated reopen/failure history |
| Normalized structures across the repo | [`../structure-radar/structure-registry.json`](../structure-radar/structure-registry.json) | Objects, equations, aliases, theorem species, applicability gaps, Arsenal decisions |
...
For theorem/obstruction lookup, read in this order:

1. [`../stage14-arsenal-index.md`](../stage14-arsenal-index.md);
2. [`../stage14-arsenal.md`](../stage14-arsenal.md);
3. only then the canonical source named by the matching entry.
...
- [`../structure-radar/structure-registry.json`](../structure-radar/structure-registry.json): main normalized mathematical registry.
- [`../structure-radar/source-manifest.json`](../structure-radar/source-manifest.json): provenance/corpus manifest.
...
- [`../structure-radar/external-gate/`](../structure-radar/external-gate/): exact theorem/adapter gaps.
...
| [`../stage23-arsenal-promotion.md`](../stage23-arsenal-promotion.md) | one-face+space -> two-face+space transition |
