...
>
> **CURRENT_BASE_COMMIT:** `5209e964a33a154be5430dee75b48748086a1a94`
>
...
FINAL_DOCUMENT=docs/stage12-final.md
...
ARCHIVE=docs/archive/stage12-n1-2/
HISTORICAL_HTML_ARCHIVE=review/archive/stage12-n1-2/
...
`docs/stage12-final.md` is the canonical Stage12 proof text for normal reading. The R09 HTML is the single active external-review page. The R09 manifest remains active for bundle identity. Earlier derivations, repairs, superseded finals, audit manifests, and R01--R08 HTML pages are archive-only history.
...
Stage13 は `docs/stage13-working-file-policy.md` に従う。数学本体は原則 `docs/stage13-main.md` 一つを canonical working source とする。

既存の Stage13-1 / Stage13-2 文書は、`stage13-main.md` を開始するときに §1 / §2 へ統合し、その後は historical initial source として保持する。修正履歴は Git commit / PR が保持する。

別ファイルへ分離するのは、data、scripts、長大で独立な support calculation、review manifest / generated HTML、archive snapshot、将来の publication draft などに限る。外部レビューは on demand とする。
...
STAGE12_CANONICAL_DOCUMENT=docs/stage12-final.md
STAGE12_ACTIVE_REVIEW_HTML=review/PC-N1-2-FINAL-SELF-CONTAINED-20260807-R09.html
STAGE12_ARCHIVE=docs/archive/stage12-n1-2/
