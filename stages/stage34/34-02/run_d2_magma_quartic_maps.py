...
for a,b,c in CASES:
    for d in (1,2):
        ...
        records.append({
            ...
            "forward_polynomials":value_after("FORWARD_POLYS:",stdout),
            "inverse_polynomials":value_after("INVERSE_POLYS:",stdout),
            "isomorphism_data_to_common_Jq":value_after("ISO_DATA_TO_JQ:",stdout),
            "forward_base_scheme_equations":value_after("FORWARD_BASE_EQS:",stdout),
...
payload={
    "schema":"STAGE34_02_D2_EXPLICIT_QUARTIC_JACOBIAN_MAP_CERTIFICATE_V1",
    "status":"PASS_MAGMA_EXPLICIT_BIRATIONAL_MAPS_TO_COMMON_JACOBIANS",
