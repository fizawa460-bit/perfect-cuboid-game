...
KEY="stages/stage34/runkeys/stage34-02-d2-stageA2-pair-model6-b13.json"
...
checks=[
 (new.get("schema")=="STAGE34_02_D2_STAGEA2_PAIR_MODEL6_B13_RUNKEY_V1","schema"),
 ...
 (new.get("quartic_search_bound")==13,"bound"),
 (new.get("process_timeout_seconds")==600,"timeout"),
 (new.get("planned_heavy_jobs")==1,"jobs"),
 (new.get("effective_heavy_concurrency")==1,"concurrency"),
 (new.get("artifact_max_bytes")==4194304,"artifact_cap"),
