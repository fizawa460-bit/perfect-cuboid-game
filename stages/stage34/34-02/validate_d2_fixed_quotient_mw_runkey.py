...
KEY="stages/stage34/runkeys/stage34-02-d2-fixed-quotient-mw.json"
...
checks=[
 (new.get("schema")=="STAGE34_02_D2_FIXED_QUOTIENT_MW_RUNKEY_V1","schema"),
 (new.get("armed") is True,"armed"),
 (isinstance(new.get("generation"),int) and new["generation"]>int(old.get("generation",0)),"generation"),
 (new.get("prime_search_interval")==[131,401],"prime_search_interval"),
 (new.get("quotient_candidates")==[4,2],"quotient_candidates"),
