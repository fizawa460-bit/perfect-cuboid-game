...
KEY="stages/stage34/runkeys/stage34-02-d2-stageA2-genus2-branch-minimal-rank-census.json"
...
checks=[(n.get("schema")=="STAGE34_02_D2_STAGEA2_GENUS2_BRANCH_MINIMAL_RANK_CENSUS_RUNKEY_V1","schema"),(n.get("armed") is True,"armed"),(isinstance(n.get("generation"),int) and n["generation"]>int(old.get("generation",0)),"generation"),(n.get("expected_branches")==52,"branches"),(n.get("planned_heavy_jobs")==1,"jobs"),(n.get("effective_heavy_concurrency")==1,"concurrency"),(n.get("maximum_external_magma_requests_at_once")==1,"requests"),(n.get("artifact_max_bytes")==1048576,"artifact"),(n.get("retention_days")==1,"retention")]
