...
KEY="stages/stage34/runkeys/stage34-02-d2-stageA2-factor-branch.json"
...
checks=[
 (new.get("schema")=="STAGE34_02_D2_STAGEA2_FACTOR_BRANCH_RUNKEY_V1","schema"),
 (new.get("armed") is True,"armed"),
 (isinstance(new.get("generation"),int) and new["generation"]>int(old.get("generation",0)),"generation"),
 (new.get("candidate_good_prime_bound")==211,"prime_bound"),
 (new.get("max_selected_good_primes_per_case")==8,"max_primes"),
