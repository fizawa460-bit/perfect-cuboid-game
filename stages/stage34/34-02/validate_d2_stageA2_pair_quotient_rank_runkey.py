...
KEY="stages/stage34/runkeys/stage34-02-d2-stageA2-pair-quotient-ranks.json"
...
checks=[
 (new.get("schema")=="STAGE34_02_D2_STAGEA2_PAIR_QUOTIENT_RANK_RUNKEY_V1","schema"),
 (new.get("armed") is True,"armed"),
 (isinstance(new.get("generation"),int) and new["generation"]>int(old.get("generation",0)),"generation"),
 (new.get("parent_branches")==92,"branches"),
 (new.get("quotient_conditions")==460,"conditions"),
 (new.get("expected_distinct_models")==48,"models"),
