...
assert ae['status'] == 'SUBMITTED_PENDING_FRESH_AUDIT'
...
assert 'CURRENT_STAGE=Stage27-40ae-SUBMITTED-PENDING-FRESH-AUDIT' in status
assert 'STAGE27_40AD_STATUS=INTERMEDIATE_AUDITED_PASS_MERGED_PR1029' in status
assert 'STAGE27_40AE_STATUS=T_OUTER_U_WEIGHTED_AVERAGING_SUBMITTED_PENDING_FRESH_AUDIT' in status
...
print('STAGE27_40AE_DOUBLE_CHARGE_FIREWALL=PASS')
