...
def main():
 ...
 req(schema in {V1,V2,V3,V4,V5,V6,V7,V8,V9,V10,V11},"unrecognized Stage36 successor schema")
 ...
 if schema==V10:
  ...
  u5=s.get("completed_units",{}).get("36-05",{}); req(u5.get("promotion_status")=="AUDITED" and u5.get("UNIFORM_FINITE_RAMIFICATION_SUPPORT_PROVED") is False and u5.get("FINITE_EXHAUSTIVE_H_TWIST_FAMILY") is False,"V11 blocked audit promotion moved")
