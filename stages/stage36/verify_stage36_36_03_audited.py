...
V10_BASE="dca962cdf37d4252316885dc57f3c0a591db4ecb"
...
PROMO_36_04={"pr":1568,"exact_head":"53b0c3b2a84ef200848d6b4b515c94589798d295","exact_head_ci_run":33924921726,"exact_head_ci_job":101191239139,"merged_main_sha":V10_BASE,"scope":"mechanical audited-state promotion only","NEW_THEOREM_CREDIT":False}
...
def main():
 ...
 req(schema in {V7,V8,V9,V10},"36-03 audited successor schema moved")
 ...
 if schema==V7:
  ...
  req(s.get("status")=="ACTIVE_PENDING_HOSTILE_AUDIT" and s.get("base_main_sha")==V8_BASE,"V8 lifecycle moved"); req(s.get("freshness_sync_36_04")==FRESHNESS_36_04,"V8 freshness sync moved"); req(g.get("pointwise_H_torsor_class_explicit") is False,"36-04 gate promoted before audit"); req(s.get("completed_units",{}).get("36-04",{}).get("promotion_status")=="PROVISIONAL_NOT_AUDITED","36-04 prematurely audited"); req("36-05" not in s.get("completed_units",{}),"36-05 started before 36-04 audit")
 elif schema==V9:
  req(s.get("status")=="ACTIVE" and s.get("base_main_sha")==V9_BASE,"V9 lifecycle moved"); req(g.get("pointwise_H_torsor_class_explicit") is True,"36-04 audited gate lost"); req(s.get("completed_units",{}).get("36-04",{}).get("promotion_status")=="AUDITED","36-04 audit provenance lost"); req(s.get("current",{}).get("unit")=="36-05","V9 successor moved"); req("36-05" not in s.get("completed_units",{}),"36-05 started inside promotion")
 else:
  ...
  req(s.get("current",{}).get("36_06_entry_allowed") is False and "36-06" not in s.get("completed_units",{}),"36-06 opened in V10")
