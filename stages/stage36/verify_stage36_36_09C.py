...
MATH_BASE='7b7971cc12bb0c9046a13a9ba956d73392178d72'
CURRENT_BASE='c3a90a8c5ccda8a649131430b92366e5f8a4cee0'
...
def main()->None:
 ...
 req(c.get('base_main_sha')==MATH_BASE,'36-09C mathematical base moved')
 entry=c.get('entry_authority',{})
 req(entry=={'stage36_36_09B_promotion_pr':1585,'promotion_exact_head':'1d29735f3f50c6918a32b2542de8364b86568396','promotion_exact_head_ci_run':33953819230,'promotion_exact_head_ci_job':101273378060,'promotion_merged_main_sha':MATH_BASE,'selected_route':'36-09C_SINGLE_PLACE_DIRECT_RECEIVER_OBSTRUCTION_PREFLIGHT'},'36-09C entry authority moved')
 ...
 req(s.get('schema')==SCHEMA and s.get('status')=='ACTIVE_PENDING_HOSTILE_AUDIT' and s.get('base_main_sha')==CURRENT_BASE,'V18 lifecycle/current base moved')
 legacy=s.get('legacy_authority_snapshot',{})
 req(legacy.get('commit')==MATH_BASE and legacy.get('blob_sha')=='a6b3c57ef9acd17125f7271a2bb409099618d3ab','V17 snapshot lock moved')
 fs=s.get('freshness_sync_36_09C',{})
 req(fs.get('main_sha')==CURRENT_BASE and fs.get('advanced_from')==MATH_BASE,'36-09C freshness sync moved')
 p=s.get('authority_frontier',{}).get('36-09B-promotion',{})
 req(p.get('pr')==1585 and p.get('exact_head')=='1d29735f3f50c6918a32b2542de8364b86568396' and p.get('exact_head_ci_run')==33953819230 and p.get('exact_head_ci_job')==101273378060 and p.get('merged_main_sha')==MATH_BASE,'36-09B promotion provenance moved')
 ...
 print(f'math_base={MATH_BASE}; current_base={CURRENT_BASE}; freshness=Stage32-only')
