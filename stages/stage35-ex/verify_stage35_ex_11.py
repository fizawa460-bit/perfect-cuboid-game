...
# Branch L: T23 iff (pq/ell)=+1, T14 iff (pq/ell)=(-1/ell).
pq = p*q
...
# Primewise routing truth-table sanity. Split primes have lambda=+1 and therefore
# the two edge conditions coincide; inert primes have lambda=-1 and are oriented.
...
print("PASS STAGE35_EX_11_RECIPROCITY_ROUTING_V1")
