...
# EX2-04A remains a retained pre-blocker claim object, but its source-lock core is
# no longer consumable after the schema-only verifier repair. No authority is inferred here.
