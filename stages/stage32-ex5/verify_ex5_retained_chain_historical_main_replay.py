...
the exact historical mutable MAIN routing, active-frontier bytes, EX5 roadmap bytes,
and retired audit contract path only for the replay, then restores the live filesystem
before current checks run.
"""
...
ROADMAP = EX5 / "stage32-ex5.md"
ARCHIVED_ROADMAP = EX5 / "archive/ex5-03-stage32-ex5-roadmap-f961f7bb.md"
...
def main() -> None:
    ...
    old_roadmap = ARCHIVED_ROADMAP.read_bytes()
    ...
    assert git_blob_sha1(old_roadmap) == "f961f7bb9c3dc9757f444798136ddae4e0e13a70"
    ...
    live_roadmap = ROADMAP.read_bytes()
    ...
    try:
        ...
        ROADMAP.write_bytes(old_roadmap)
        ...
        ROADMAP.write_bytes(live_roadmap)
    ...
    assert ROADMAP.read_bytes() == live_roadmap
