...
def main():
    ...
    req(s["schema"]=="STAGE32EX5_MAIN_COMPACT_STATE_V1_EX5_07_EFC_BLOCKED","schema drift")
    ...
    req(f["backup_2_preflight_complete"] is False,"EHS preflight precredited")
    ...
    req(r["backup_1_preflight_artifact"]=="stages/stage32-ex5/ex5-07-efc-preflight-01.json","EFC artifact drift")
    req(r["backup_1_preflight_verifier"]=="stages/stage32-ex5/verify_ex5_07_efc_preflight_01.py","EFC verifier drift")
    req(r["backup_2_route_id"]=="EX5R-EHS-001" and r["backup_2_route_status"]=="SELECTED_NEXT","EHS next status drift")
    req(r["next_selected_route_id"]=="EX5R-EHS-001","EHS must be next")
    ...
    cur=s["current"]
    req(cur["status"]=="EX5_07_EFC_PREFLIGHT_BLOCKED_RETAINED","current status drift")
    req(cur["leaf"]=="EX5-07_PRIMARY_ROUTE_MICRODIAGNOSTIC","leaf drift")
    req(cur["subroute"]=="EXECUTE_EHS_PREFLIGHT_01_AFTER_XSTAGE_AND_EFC_BLOCKED","subroute drift")
    req(cur["next_route_on_block"]=="EX5-10_RESIDUAL_PACKAGE_STATUS_OR_RESERVE_ROUTE_REVIEW","EHS block routing drift")
    req(s["current_leaf_working_set"]==["stages/stage32-ex5/ex5-07-efc-preflight-01.json","stages/stage32-ex5/verify_ex5_07_efc_preflight_01.py","stages/stage32-ex5/ex5-06-executable-route-contracts.json","stages/stage32-ex5/ex5-04-repository-asset-dedup.json","stages/stage32-ex5/ex5-01-exact-receiver-ledger.json"],"working set drift")
    req(s["credit"]["level"]=="EX5_07_XSTAGE_AND_EFC_TYPED_BLOCKERS_NO_RECEIVER_EFFECT","credit level drift")
    ...
    print("PASS: Stage32EX5 state through XSTAGE+EFC typed blockers; EHS selected next")
