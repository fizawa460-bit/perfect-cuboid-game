...
BC2_32 = HERE / "bc2-32-fresh-unknown170-replay-checkpoint.json"

BC2_32_CANONICAL = "905b416477b23199c794a1267e143158e0dac7baaaa9f809d9cd8528e8e4aa6c"
BC2_32_BLOB = "d21a3ddd3c2e06dd5523777aa3141ff41392a467"
...
UNKNOWN_SHA = "e617578c83e604866c22de5d38d62d93fe4453886b0d46ddce609bce87308492"
PRIOR_UNSAT = 7229
TARGET_COUNT = 107
TIMEOUT_MS = 40000
...
def load_checkpoint() -> dict:
    raw = BC2_32.read_bytes()
    if git_blob_sha(BC2_32) != BC2_32_BLOB:
        raise ValueError("BC2-32 checkpoint blob drift")
    cp = json.loads(raw)
    q = dict(cp)
    got = q.pop("canonical_sha256_without_this_field", None)
    if got != BC2_32_CANONICAL or csha(q) != BC2_32_CANONICAL:
        raise ValueError("BC2-32 checkpoint canonical drift")
    r = cp["replay"]
    ids = [int(v) for v in r["unknown_parent_indices"]]
    if (
        r["parents_checked"] != 170
        or r["unsat_count"] != 63
        ...
        raise ValueError("BC2-32 audited target drift")
    return cp
...
def main() -> None:
    ...
    if args.per_parent_timeout_ms != TIMEOUT_MS:
        raise ValueError("BC2-33 is locked to 40000 ms per audited UNKNOWN parent")
    ...
    all107_unsat = len(unsat_indices) == TARGET_COUNT and not unknown_indices and not sat_witnesses
    if sat_witnesses:
        ...
        status = "PASS_TARGETED_REPLAY_ALL_107_EXACT_UNSAT_CANDIDATE_CLOSURE"

    body = {
        "schema": "STAGE32EX5_BC2_33_FRESH_UNKNOWN107_REPLAY_V1",
        "stage": "32EX5",
        "unit": "BC2_33_REFINE_REMAINING_FRESH_UNKNOWN_SET",
        "status": status,
        "audit_consumption": {
            "bc2_32_hostile_audit_status": "PASS",
            "bc2_32_hostile_audit_exact_head": BC2_32_AUDIT_HEAD,
            "bc2_32_hostile_audit_review_id": BC2_32_AUDIT_REVIEW,
        },
        "source_locks": {
            "bc2_32_checkpoint_canonical": BC2_32_CANONICAL,
            "bc2_32_checkpoint_git_blob_sha": BC2_32_BLOB,
            "bc2_32_producer_git_blob_sha": B32_BLOB,
            "bc2_19_replay_source_git_blob_sha": b32.B19_BLOB,
            "bc2_18_enumerator_source_git_blob_sha": b32.D18_BLOB,
        ...
        "target": {
            "audited_bc2_32_unknown_count": TARGET_COUNT,
        ...
        "credit": {
            ...
            "whole_first_block_picard64_unsat_candidate": all107_unsat,
        ...
        "next_exact_unit": {
            "id": "HOSTILE_AUDIT_BC2_33_TARGETED_REPLAY",
            "post_audit_if_unknown": "BC2_34_REFINE_REMAINING_FRESH_UNKNOWN_SET",
            "post_audit_if_sat": "BC2_34_ANALYZE_PICARD64_FEASIBLE_WITNESS_NO_CURVE_CREDIT",
            "post_audit_if_all_unsat": "BC2_34_CONSUME_FIRST_BLOCK_PICARD64_CLOSURE_CANDIDATE",
