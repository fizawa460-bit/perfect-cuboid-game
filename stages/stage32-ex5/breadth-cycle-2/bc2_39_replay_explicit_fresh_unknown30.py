...
import bc2_38_replay_explicit_fresh_unknown34 as b38

HERE = Path(__file__).resolve().parent
BC2_38 = HERE / "bc2-38-fresh-unknown34-replay-checkpoint.json"

BC2_38_CANONICAL = "88b41680df6bb78f8b7f8ca00cde121d909a39e7b3c29eef765edb77b2c022ba"
BC2_38_BLOB = "91eca02054cd2dbf702dd4a7635398ef76ee832f"
BC2_38_SOURCE_BLOB = "6fb0af6c77e44edfa5d2b8a13fbde73bfbd468aa"
BC2_38_AUDIT_HEAD = "5e1d07e4c92fbecff9bfa89b0bfb65cdaf564a71"
BC2_38_AUDIT_REVIEW = 5190676180
...
def load_target() -> dict:
    cp = checked(BC2_38, BC2_38_CANONICAL, BC2_38_BLOB)
    r = cp["replay"]
    ids = [int(v) for v in r["unknown_parent_indices"]]
    if (
        r["parents_checked"] != 34
        or r["unsat_count"] != 4
        ...
        raise ValueError("BC2-38 audited target drift")
    return cp
...
def main() -> None:
    ...
    if args.per_parent_timeout_ms != TIMEOUT_MS:
        raise ValueError("BC2-39 is locked to 160000 ms per audited UNKNOWN parent")

    if git_blob_sha(Path(b38.__file__).resolve()) != BC2_38_SOURCE_BLOB:
        raise ValueError("BC2-38 producer blob drift")
    b32 = b38.b37.b36.b32
    ...
    if sat_witnesses:
        ...
        status = "PASS_TARGETED_REPLAY_ALL_30_EXACT_UNSAT_CANDIDATE_CLOSURE"

    body = {
        "schema": "STAGE32EX5_BC2_39_FRESH_UNKNOWN30_REPLAY_V1",
        "stage": "32EX5",
        "unit": "BC2_39_REFINE_REMAINING_FRESH_UNKNOWN_SET",
        "status": status,
        "audit_consumption": {
            "bc2_38_hostile_audit_status": "PASS",
            "bc2_38_hostile_audit_exact_head": BC2_38_AUDIT_HEAD,
            "bc2_38_hostile_audit_review_id": BC2_38_AUDIT_REVIEW,
        },
        "source_locks": {
            "bc2_38_checkpoint_canonical": BC2_38_CANONICAL,
            "bc2_38_checkpoint_git_blob_sha": BC2_38_BLOB,
            "bc2_38_producer_git_blob_sha": BC2_38_SOURCE_BLOB,
        ...
        "target": {
            "audited_bc2_38_unknown_count": TARGET_COUNT,
        ...
        "next_exact_unit": {
            "id": "HOSTILE_AUDIT_BC2_39_TARGETED_REPLAY",
            "post_audit_if_unknown": "BC2_40_REFINE_REMAINING_FRESH_UNKNOWN_SET",
            "post_audit_if_sat": "BC2_40_ANALYZE_PICARD64_FEASIBLE_WITNESS_NO_CURVE_CREDIT",
            "post_audit_if_all_unsat": "BC2_40_CONSUME_FIRST_BLOCK_PICARD64_CLOSURE_CANDIDATE",
