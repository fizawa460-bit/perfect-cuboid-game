...
import bc2_37_replay_explicit_fresh_unknown41 as b37

HERE = Path(__file__).resolve().parent
BC2_37 = HERE / "bc2-37-fresh-unknown41-replay-checkpoint.json"

BC2_37_CANONICAL = "286e40b0004b978cdbbc3829c600383c34a8bdc4e1492c54d99a2400258e37b7"
BC2_37_BLOB = "6ac4592eded6be2bf80e88c33d0ac5944f13afaf"
BC2_37_SOURCE_BLOB = "35a1644c197fd32aec845332452cc918f3bc75d9"
BC2_37_AUDIT_HEAD = "9852fcec959962607da3290100291a60185e7104"
...
def load_target() -> dict:
    cp = checked(BC2_37, BC2_37_CANONICAL, BC2_37_BLOB)
    r = cp["replay"]
    ids = [int(v) for v in r["unknown_parent_indices"]]
    if (
        r["parents_checked"] != 41
        or r["unsat_count"] != 7
        ...
        raise ValueError("BC2-37 audited target drift")
    return cp
...
def main() -> None:
    ...
    if args.per_parent_timeout_ms != TIMEOUT_MS:
        raise ValueError("BC2-38 is locked to 140000 ms per audited UNKNOWN parent")

    if git_blob_sha(Path(b37.__file__).resolve()) != BC2_37_SOURCE_BLOB:
        raise ValueError("BC2-37 producer blob drift")
    b32 = b37.b36.b32
    ...
    if sat_witnesses:
        ...
        status = "PASS_TARGETED_REPLAY_ALL_34_EXACT_UNSAT_CANDIDATE_CLOSURE"

    body = {
        "schema": "STAGE32EX5_BC2_38_FRESH_UNKNOWN34_REPLAY_V1",
        "stage": "32EX5",
        "unit": "BC2_38_REFINE_REMAINING_FRESH_UNKNOWN_SET",
        "status": status,
        "audit_consumption": {
            "bc2_37_hostile_audit_status": "PASS",
            "bc2_37_hostile_audit_exact_head": BC2_37_AUDIT_HEAD,
            "bc2_37_hostile_audit_review_id": BC2_37_AUDIT_REVIEW,
        },
        "source_locks": {
            "bc2_37_checkpoint_canonical": BC2_37_CANONICAL,
            "bc2_37_checkpoint_git_blob_sha": BC2_37_BLOB,
            "bc2_37_producer_git_blob_sha": BC2_37_SOURCE_BLOB,
        ...
        "target": {
            "audited_bc2_37_unknown_count": TARGET_COUNT,
        ...
        "next_exact_unit": {
            "id": "HOSTILE_AUDIT_BC2_38_TARGETED_REPLAY",
            "post_audit_if_unknown": "BC2_39_REFINE_REMAINING_FRESH_UNKNOWN_SET",
            "post_audit_if_sat": "BC2_39_ANALYZE_PICARD64_FEASIBLE_WITNESS_NO_CURVE_CREDIT",
            "post_audit_if_all_unsat": "BC2_39_CONSUME_FIRST_BLOCK_PICARD64_CLOSURE_CANDIDATE",
