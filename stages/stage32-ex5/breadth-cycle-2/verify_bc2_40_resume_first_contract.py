...
WORKFLOW_BLOB='e4b60e4f5664d5da134b25ff66cceb2125dd44a8'
...
def main():
    ...
    req(c['workflow_requirements']['partial_upload_if_always_or_equivalent_required'] is True and c['workflow_requirements']['effective_heavy_concurrency']==1,'workflow requirements')
