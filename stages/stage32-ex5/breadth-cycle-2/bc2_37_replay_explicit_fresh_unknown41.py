...
import bc2_36_replay_explicit_fresh_unknown52 as b36

HERE = Path(__file__).resolve().parent
BC2_36 = HERE / "bc2-36-fresh-unknown52-replay-checkpoint.json"

BC2_36_CANONICAL = "e92cd6d07299b833a79fe20b81e9de032d61790cf1b7a6fb81ec6adccdb49fdf"
BC2_36_BLOB = "09ac58349e388c479ac77e04724bef2fd9b49b7e"
BC2_36_SOURCE_BLOB = "18f9c2146d5dc97400c4af1a8691560523cc03cf"
BC2_36_AUDIT_HEAD = "9c63ccb48dd0e5bdeedda7739dd05e2404698465"
BC2_36_AUDIT_REVIEW = 5188625406
...
def load_target() -> dict:
    cp = checked(BC2_36, BC2_36_CANONICAL, BC2_36_BLOB)
    r = cp["replay"]
    ids = [int(v) for v in r["unknown_parent_indices"]]
    if (
        r["parents_checked"] != 52
        or r["unsat_count"] != 11
        ...
        raise ValueError("BC2-36 audited target drift")
    return cp
...
def main() -> None:
    ...
    if args.per_parent_timeout_ms != TIMEOUT_MS:
        raise ValueError("BC2-37 is locked to 120000 ms per audited UNKNOWN parent")

    if git_blob_sha(Path(b36.__file__).resolve()) != BC2_36_SOURCE_BLOB:
        raise ValueError("BC2-36 producer blob drift")
    b32 = b36.b32
    ...
    if sat_witnesses:
        ...
        status = "PASS_TARGETED_REPLAY_ALL_41_EXACT_UNSAT_CANDIDATE_CLOSURE"

    body = {
        "schema": "STAGE32EX5_BC2_37_FRESH_UNKNOWN41_REPLAY_V1",
        "stage": "32EX5",
        "unit": "BC2_37_REFINE_REMAINING_FRESH_UNKNOWN_SET",
        "status": status,
        "audit_consumption": {
            "bc2_36_hostile_audit_status": "PASS",
            "bc2_36_hostile_audit_exact_head": BC2_36_AUDIT_HEAD,
            "bc2_36_hostile_audit_review_id": BC2_36_AUDIT_REVIEW,
        },
        "source_locks": {
            "bc2_36_checkpoint_canonical": BC2_36_CANONICAL,
            "bc2_36_checkpoint_git_blob_sha": BC2_36_BLOB,
            "bc2_36_producer_git_blob_sha": BC2_36_SOURCE_BLOB,
        ...
        "target": {
            "audited_bc2_36_unknown_count": TARGET_COUNT,
        ...
        "next_exact_unit": {
            "id": "HOSTILE_AUDIT_BC2_37_TARGETED_REPLAY",
            "post_audit_if_unknown": "BC2_38_REFINE_REMAINING_FRESH_UNKNOWN_SET",
            "post_audit_if_sat": "BC2_38_ANALYZE_PICARD64_FEASIBLE_WITNESS_NO_CURVE_CREDIT",
            "post_audit_if_all_unsat": "BC2_38_CONSUME_FIRST_BLOCK_PICARD64_CLOSURE_CANDIDATE",
