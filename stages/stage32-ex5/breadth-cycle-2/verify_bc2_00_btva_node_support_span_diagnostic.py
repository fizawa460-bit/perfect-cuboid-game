...
def main():
    ...
    if schema == V34:
        ...
        req(f['e8_bc2_39_audited'] is True and f['e8_bc2_39_remaining_unknown_count']==23 and f['e8_bc2_39_sat_count']==0 and f['e8_known_parent_unsat_count_lower_bound']==7313 and f['e8_bc2_40_preflight_ready'] is True and f['e8_bc2_40_execution_authorized'] is True and f['e8_bc2_40_executed'] is False and f['e8_bc2_40_target_unknown_count']==23,'BC2-40 V34 frontier drift')
        execution=state['execution']; req(execution['dedicated_runkey']=='stages/stage32-ex5/runkeys/bc2-40-fresh-unknown23-replay.json' and execution['effective_heavy_concurrency']==1 and execution['runkey_armed'] is True and execution['heavy_scaleout_authorized'] is False,'BC2-40 V34 execution drift')
    elif schema == V33:
        req(a['last_hostile_audit_exact_head']=='4b974550d9ad030973fec99e19a090f6785f8aa8' and a['last_hostile_audit_review_id']==5193423203,'BC2-39 audit receipt drift')
