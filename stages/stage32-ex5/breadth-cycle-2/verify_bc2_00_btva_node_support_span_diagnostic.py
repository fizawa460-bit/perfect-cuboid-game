...
def main() -> None:
    ...
    if schema.endswith("BC2_31_RECOVERY_EXECUTION"):
        ...
        req(frontier["e8_bc2_34_executed"] is False and frontier["e8_known_parent_unsat_count_lower_bound"] == 7255, "BC2-34 pre-execution frontier drift")
    elif schema.endswith("BC2_34_TARGETED_REPLAY_AUDIT_BOUNDARY"):
        req(audit["last_hostile_audit_exact_head"] == "241d65c51f93b66b79f7e8407891cc46359a45c9", "BC2-33 predecessor audit head drift")
        req(audit["last_hostile_audit_review_id"] == 5185961173, "BC2-33 predecessor audit review drift")
        ...
        req(audit["bc2_34_execution_authorized"] is False, "BC2-34 execution left authorized")
        req(cur["next_route"] == "HOSTILE_AUDIT_BC2_34_TARGETED_REPLAY", "BC2-34 audit route drift")
        ...
        req(audit["last_hostile_audit_exact_head"] == "cdb455860849cfd064e3ab8c83d6d4993fb5ff1b", "BC2-34 re-audit head drift")
        req(audit["last_hostile_audit_review_id"] == 5186516652, "BC2-34 re-audit review drift")
        req(audit["new_audit_boundary_exists"] is False and audit["freeze_active"] is False and audit["re_audit_required"] is False, "BC2-35 execution freeze drift")
        req(audit["bc2_35_execution_authorized"] is True and audit["bc2_34_execution_authorized"] is False, "BC2-35 execution authority drift")
        req(cur["next_route"] == "BC2_35_REFINE_REMAINING_FRESH_UNKNOWN_SET", "BC2-35 route drift")
        req(frontier["e8_bc2_34_audited"] is True and frontier["e8_bc2_35_executed"] is False, "BC2-35 pre-execution receipt drift")
        req(frontier["e8_bc2_35_target_unknown_count"] == 64 and frontier["e8_known_parent_unsat_count_lower_bound"] == 7272, "BC2-35 pre-execution frontier drift")
