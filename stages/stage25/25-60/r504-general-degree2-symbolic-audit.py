...
cond=sp.factor(E*B**2-A*D**2)
assert cond==16*(a-b)**3*(a+b)*(a*b-1)*(a*b+1)
...
q1=(AA,0,sp.factor(BB-4*AA),0,sp.factor(2*AA-2*BB+CC))
I1,J1=IJ(*q1)
...
subs={b:1/a}; lam=1/a
AA,BB,CC,DD,EE=[sp.factor(z.subs(subs)) for z in (A,B,C,D,E)]
q2=(AA,0,sp.factor(BB-4*lam*AA),0,sp.factor(2*lam**2*AA-2*lam*BB+CC))
I2,J2=IJ(*q2)
