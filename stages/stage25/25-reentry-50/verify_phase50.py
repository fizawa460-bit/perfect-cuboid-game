...
# Frozen source/target/control interfaces.
...
assert reg['principal_sector']['net_log_surplus_relative_to_source']==2
assert reg['principal_sector']['principal_sector_carries_main_term'] is True
assert reg['principal_sector']['every_nonprincipal_effective_sector_loses_at_least_one_pole'] is True
assert 'LOG2_NET_PRINCIPAL_POLE_SURPLUS=2' in res
assert 'LOG2_LOCALIZED_TO_SHARED_P_PRINCIPAL_BULK=true' in res

# No illicit factorization.
g=reg['open_gate']
...
# G22 bridge must remain a question, not a 2+2 theorem.
...
print('STAGE25_REENTRY_PHASE50_NET_POLE_SURPLUS=PASS')
print('STAGE25_REENTRY_PHASE50_NO_FAKE_FACTOR_SPLIT=PASS')
