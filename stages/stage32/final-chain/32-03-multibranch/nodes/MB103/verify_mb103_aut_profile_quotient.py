...
def main() -> None:
    ...
    required_fields = {
        "r_i", "M_i", "branch_multiplicities_m_ij", "resolved_landing_partition",
        "intrinsic_branch_delta_values", "pairwise_local_intersection_multiplicities",
        "Delta_i_exc", "multibranch_membership",
    }
    require(required_fields <= fields, "complete transported packet")

    tr = cert["transport_contract"]
    for key in [
        "node_labels_may_permute", "actual_resolved_landing_points_are_transported",
        "branch_multiplicities_preserved", "resolved_landing_partition_preserved_up_to_transport",
        "local_delta_data_preserved", "pairwise_intersection_data_preserved",
    ...
    require(fw["mb101_retained"] and fw["mb102_retained"] and fw["mb103_retained"],
            "retained chain")
    for key in [
        "mb104_complete", "mb105_complete", "finite_picard_enumeration_released",
        "r29_lg2_mb_discharged", "receiver_credit", "effectivity_credit",
        "final_milestone_credit", "theorem_credit", "endpoint_credit",
