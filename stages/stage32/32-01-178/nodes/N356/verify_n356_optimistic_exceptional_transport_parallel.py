...
def main() -> None:
    locker = load_locked(LOCKER, EXPECTED_LOCKER_BLOB, "s32_n356_dependency_locks_parallel")
    locker.validate_n356_dependency_source_locks()
    engine = load_locked(ENGINE, EXPECTED_ENGINE_BLOB, "s32_n356_locked_parallel_engine")
    engine.main()
