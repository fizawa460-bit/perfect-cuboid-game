...
N365_RESULT = HERE.parent / "N365/RESULT.json"
...
STATE_BLOB = "080b4b73f9139c4c3610cfe12edb70b5af937eec"
STATE_CANON = "a0d23b89fe0aa7e43eb8f54dcfbcf0c3367a7240c4b0c9148a8eac96f846a16d"
N365_RESULT_BLOB = "b20c3d61078a12bb9e6aa48632b8d66b03b414a2"
N365_RESULT_CANON = "1f56cc78040081317053fe02ce797f9bc2d126ef885012011eb5544b59b3ecce"
N365_GENERATOR_BLOB = "9641ac7b75cf714dc660e5cb34105dd54918185f"
BLOCK, OFFSET, WIDTH = 1386, 967, 113
EXPECTED_PARENT_COUNT = 316
EXPECTED_RESIDUAL_COUNT = 4
EXPECTED_RESIDUAL_STREAM = "bb884f679520b90218880d8a6285ffd9327d2fa139f3c7dbe4dfaf990fdd80ef"
...
def preflight(cut_root: Path, comp_root: Path):
    ...
    n365r = checked(N365_RESULT, N365_RESULT_BLOB, N365_RESULT_CANON)
    ...
    req(n365r["status"] == "NO_SAT_IN_THREE_PARENT_PROBE" and n365r["witness"] is None, "N365 result drift")
    req(n365r["target"]["parent_ordinals"] == [2,6,14], "N365 ordinal result drift")
    ...
    cut196 = load_module(cut_root / "stages/stage32/full178-cut/cut196_e8_common_adapter_wave4.py", "n366_cut196")
    cut196.preflight()
    comp = load_module(comp_path, "n366_n357comp")
    n365 = load_module(N365_GENERATOR, "n366_n365_solver")
...
def residual_ordinals(core, P, blocks, g) -> list[int]:
    ...
    req(len(parents) == EXPECTED_PARENT_COUNT, "block1386 parent population drift")
...
def main() -> None:
    ...
    req(survivors[OFFSET] == BLOCK and OFFSET > 765, "block1386 offset drift")
    ...
    for ordinal in ordinals:
        ...
        if candidate is not None:
            candidate["schema"] = "STAGE32_32_01_178_N366_CURRENT_V15_SELECTED64_WITNESS_V1"
    ...
    if witness:
        ...
        status = "UNKNOWN_REMAINS_IN_FOUR_PARENT_PROBE"
    else:
        status = "NO_SAT_IN_FOUR_PARENT_PROBE"
    body = {
        "schema": "STAGE32_32_01_178_N366_BLOCK1386_FOUR_PARENT_WITNESS_RESULT_V1",
        "status": status,
