...
N368_RESULT = HERE.parent / "N368/RESULT.json"
...
STATE_BLOB = "7d0ffbdac28466cce0b9421afa985993ab301419"
STATE_CANON = "87fb7a8d9bef4c1f03b087409a5b76e852c5646b3a429ded6d40835c551e9695"
N368_RESULT_BLOB = "45efcc355e9462d2584cbc0dedb896bea6a924d5"
N368_RESULT_CANON = "d13cc0c842b0495e3baa08f40e69d353641dab109b9b1e05b83d29c45917f4e7"
N365_GENERATOR_BLOB = "9641ac7b75cf714dc660e5cb34105dd54918185f"
BLOCK, OFFSET, WIDTH = 1134, 793, 113
EXPECTED_PARENT_COUNT = 1560
SOURCE_RESIDUAL_COUNT = 32
SOURCE_RESIDUAL_STREAM = "39697a61bb00962a0c392241ac47139ff9db61ae8f1f4415355dd2280c2b9055"
...
def preflight(cut_root: Path, comp_root: Path):
    ...
    n368 = checked(N368_RESULT, N368_RESULT_BLOB, N368_RESULT_CANON)
    ...
    req(n368["status"] == "NO_SAT_IN_INDEPENDENT_RESIDUAL_PROBE" and n368["witness"] is None, "N368 result drift")
    req(n368["target"]["block_index"] == 1260, "N368 target drift")
    req(n368["route_replay"]["independent_replay_unresolved_count"] == 7, "N368 replay count drift")
    ...
    req(state["selection_provenance"]["cut196_source_residual_parent_count"] == SOURCE_RESIDUAL_COUNT, "N369 source residual count drift")
    req(state["selection_provenance"]["cut196_source_residual_parent_ordinal_sha256"] == SOURCE_RESIDUAL_STREAM, "N369 source residual digest drift")
    ...
    cut196 = load_module(cut_root / "stages/stage32/full178-cut/cut196_e8_common_adapter_wave4.py", "n369_cut196")
    cut196.preflight()
    comp = load_module(comp_path, "n369_n357comp")
    n365 = load_module(N365_GENERATOR, "n369_n365_solver")
...
def main() -> None:
    ...
    for ordinal in ordinals:
        ...
        if candidate is not None:
            candidate["schema"] = "STAGE32_32_01_178_N369_CURRENT_V15_SELECTED64_WITNESS_V1"
    ...
    body = {
        "schema": "STAGE32_32_01_178_N369_BLOCK1134_INDEPENDENT_FINITE_RING_RESIDUAL_WITNESS_RESULT_V1",
        "status": status,
