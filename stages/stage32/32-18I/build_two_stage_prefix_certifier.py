...
NEW_SCHEMA = "STAGE32_18I_D16_EXACT_TWO_STAGE_SHARDED_TRAVERSAL_CERT_V1"
...
'''
    new = '''                bool take=true;
                ...
                if(take) dfs(i-1,used+term);
'''
    text = replace_once(text, old, new, "two-stage DFS partition")

    old_meta = '        f<<"  \\"split_coordinate\\": "<<split_i_<<",\\n";\n'
    new_meta = old_meta + (
    ...
    text = replace_once(text, old_meta, new_meta, "two-stage metadata")
    args.output.write_text(text)
    print({"schema": NEW_SCHEMA, "primary": [54, 26, 1024], "secondary_cli": True})
