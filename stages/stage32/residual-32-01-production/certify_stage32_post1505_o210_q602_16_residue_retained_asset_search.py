...
def main() -> None:
    ...
    assert controller["schema"] == "STAGE32_LOWGENUS_PICARD_CONTROLLER_V237_POST1505_Q602_16_MULTI_REGISTRY_SEARCH_AUDIT_REPAIR"
    assert controller["status"] == "STAGE32_O210_Q602_AUDITED_16_MULTI_REGISTRY_SEARCH_AUDIT_REPAIR_PENDING_HOSTILE_REAUDIT"
    assert controller["current_item"] == "O210_Q602_AUDITED_16_MULTI_REGISTRY_SEARCH_AUDIT_REPAIR_PENDING_HOSTILE_REAUDIT"
    ctl_leaf = controller["current_leaf"]
    assert ctl_leaf["status"] == "PROVISIONAL_EXACT_BOUNDED_NEGATIVE_RETAINED_ASSET_SEARCH_AUDIT_REPAIR_PENDING_HOSTILE_REAUDIT"
    ...
    print(json.dumps({
        ...
        "bounded_search": "multi-registry route replayed",
