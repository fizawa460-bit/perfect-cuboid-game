...
The recovered V6 witness gives the exact all-140 Picard pairing vector. On the six retained second-factor boundary curves
...
This leaf does not need an absolute labeling of those two 3-cycles. It exhausts every permutation of six objects having cycle type `(3,3)`.
...
where `b3` is realized by an ambient/retained-Picard symmetry that permutes the six second-factor boundary curves as the Bolza branch points and carries the V6 class into its H-deck orbit.
