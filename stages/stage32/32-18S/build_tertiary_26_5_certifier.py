...
OLD_SCHEMA = "STAGE32_18Q_D16_B14_EXACT_TWO_STAGE_SHARDED_TRAVERSAL_CERT_V1"
NEW_SCHEMA = "STAGE32_18S_D16_B14_EXACT_THREE_STAGE_SHARDED_TRAVERSAL_CERT_V1"
...
'''
    new = '''                bool take=true;
                ...
                if(take) dfs(i-1,used+term);
'''
    text = once(text, old, new, "three-stage DFS partition")
...
'''
    new_meta = '''        f<<"  \\"shard_id\\": "<<shard_id_<<",\\n";
        ...
        f<<"  \\"owned_prefixes\\": "<<owned_prefixes_<<",\\n";
'''
    text = once(text, old_meta, new_meta, "three-stage metadata")
    ...
    text = once(text, old_members, new_members, "secondary counters")
