...
CURRENT_STATE_BLOB = "c7fac09b774d8fc75ba3daa1b9320dbb66b81a6d"
CURRENT_STATE_CANON = "22e2ae97041b175bc5901572d2490f6d14ad1dd34cf96687f955679be92e4d12"
...
def main() -> None:
    req(blob(STATE) == CURRENT_STATE_BLOB, "current V24 MAIN-STATE blob drift")
    state = json.loads(STATE.read_text(encoding="utf-8"))
    req(state.get("canonical_sha256_without_this_field") == CURRENT_STATE_CANON, "current V24 MAIN-STATE stored canonical drift")
    req(canon(state) == CURRENT_STATE_CANON, "current V24 MAIN-STATE canonical drift")
    ...
    req(f["hpadj07_hostile_audit_review_id"] == HPADJ_REVIEW, "HPADJ07 audit review drift")
    ...
    req(state["firewalls"]["replacement_head_hostile_reaudit_required"] is True, "replacement-head audit firewall")
    ...
    req(blob(STATE) == CURRENT_STATE_BLOB, "current V24 MAIN-STATE restore failed")
    print("PASS: Stage32 cross-lane demand DAG retained across HPADJ07 V24 authority transition")
    print("HPADJ07=MAIN_LOWER_BOUND_CREDIT_CONSUMED; operational demand/interface history preserved")
