...
Each variant runs b10 and is compared against:
...
A repaired audited-b8 predecessor regression is evidence about the cause of the known 22 losses only. It does **not** prove the remaining floating LDL/radius/reach traversal complete, and it does not certify any norm-10 count. The next required test after this scout is comparison against the complete exact b10 set from Stage32-18C.
