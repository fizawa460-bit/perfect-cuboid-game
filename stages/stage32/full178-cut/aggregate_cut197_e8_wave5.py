...
SCHEMA = "STAGE32_CUT197_E8_COMMON_ADAPTER_WAVE5_AGGREGATE_V1"
SHARD_SCHEMA = "STAGE32_CUT197_E8_COMMON_ADAPTER_WAVE5_SHARD_V1"
EXPECTED_RANGES = [(1021,1052),(1053,1084),(1085,1116),(1117,1148),(1149,1180),(1181,1212),(1213,1244),(1245,1275)]
MAIN_V12_TERMINALS = 65396964990500233636101
PRIOR = {"cut193":25651,"cut194":26442,"cut195":26216,"cut196":27346}
...
def main():
    ...
    files=sorted(args.input_dir.glob("cut197-shard-*.json")); req(len(files)==8,f"expected 8 shards, got {len(files)}")
    ...
    for s in shards:
        ...
        for k in ["cut191_block0_disjoint","cut193_wave1_disjoint","cut194_wave2_disjoint","cut195_wave3_disjoint","cut196_wave4_disjoint","n356_preserved_all_wave_blocks"]:
    ...
    req(len(all_blocks)==255 and len(set(all_blocks))==255,"wave5 block population drift")
    ...
    body={
      "schema":SCHEMA,"stage":"32","surface":"full178-cut","node":"CUT197","status":"WAVE5_CANDIDATE_AUDIT_REQUIRED",
      "source":{"cut196_pr":1793,"cut196_audited_exact_head":"85f4e988acf6446fa0d472208e21990621a650b4","cut196_exact_head_ci":34687223279,"cut196_hostile_audit_review":5186302071,"cut196_audited_candidate_pruned_terminals":PRIOR["cut196"],"cut195_audited_candidate_pruned_terminals":PRIOR["cut195"],"cut194_audited_candidate_pruned_terminals":PRIOR["cut194"],"cut193_audited_candidate_pruned_terminals":PRIOR["cut193"],"main_v12_exact_head":"6d63d798adb50dd4efc5f0d5abc553b3dfa23060","ex5_producer_exact_head":"fd00531181228c9f367a49eb61ddc3af6ab84ab3","ex5_producer_ci_run":34598945799},
      "target":{"row_id":"g1-d008","g":1,"d":8,"e":8,"survivor_offset_range":[1021,1275],"block_count":255,"terminal_count":28815,"block_indices":all_blocks,"block_index_stream_sha256":h.hexdigest(),"cut191_block0_disjoint":True,"cut193_wave1_disjoint":True,"cut194_wave2_disjoint":True,"cut195_wave3_disjoint":True,"cut196_wave4_disjoint":True,"n356_preserved_all_wave_blocks":True},
      "result":{"candidate_closed_block_indices":closed,"candidate_closed_block_count":len(closed),"candidate_closed_block_stream_sha256":ch.hexdigest(),"candidate_pruned_terminals":candidate,"candidate_post_wave5_from_main_v12_terminals":MAIN_V12_TERMINALS-candidate,"candidate_post_cut193_cut194_cut195_cut196_cut197_from_main_v12_terminals":MAIN_V12_TERMINALS-sum(PRIOR.values())-candidate,"remaining_nonclosed_block_count":residual,"method_counts":methods,"hnf_empty_block_count":zero_hnf,"whole_block_finite_ring_unsat_count":whole,"all_parent_finite_ring_unsat_block_count":parent_all},
