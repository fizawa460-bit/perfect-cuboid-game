...
SCHEMA = "STAGE32_CUT194_E8_COMMON_ADAPTER_WAVE2_AGGREGATE_V1"
SHARD_SCHEMA = "STAGE32_CUT194_E8_COMMON_ADAPTER_WAVE2_SHARD_V1"
EXPECTED_RANGES = [(256,287),(288,319),(320,351),(352,383),(384,415),(416,447),(448,479),(480,510)]
...
def main():
    ...
    files = sorted(args.input_dir.glob("cut194-shard-*.json"))
    ...
    req(len(all_blocks) == 255 and len(set(all_blocks)) == 255 and 0 not in all_blocks, "wave2 block population drift")
    ...
    body = {
        ...
        "surface": "full178-cut",
        "node": "CUT194",
        "status": "WAVE2_CANDIDATE_AUDIT_REQUIRED",
        "source": {
            "cut193_pr": 1786,
            "cut193_audited_exact_head": "5b2ebb3f67805eddefef835878ba4b9744bfdbd9",
        ...
        "result": {
            ...
            "candidate_post_wave2_from_main_v12_terminals": MAIN_V12_TERMINALS - candidate,
            "candidate_post_cut193_plus_cut194_from_main_v12_terminals": MAIN_V12_TERMINALS - CUT193_AUDITED_CANDIDATE - candidate,
