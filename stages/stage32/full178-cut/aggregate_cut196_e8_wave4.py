...
SCHEMA = "STAGE32_CUT196_E8_COMMON_ADAPTER_WAVE4_AGGREGATE_V1"
SHARD_SCHEMA = "STAGE32_CUT196_E8_COMMON_ADAPTER_WAVE4_SHARD_V1"
EXPECTED_RANGES = [(766,797),(798,829),(830,861),(862,893),(894,925),(926,957),(958,989),(990,1020)]
MAIN_V12_TERMINALS = 65396964990500233636101
CUT193_AUDITED_CANDIDATE = 25651
CUT194_AUDITED_CANDIDATE = 26442
CUT195_AUDITED_CANDIDATE = 26216
...
def main():
    ...
    files = sorted(args.input_dir.glob("cut196-shard-*.json"))
    ...
    for s in shards:
        ...
        req(s["target"]["cut195_wave3_disjoint"] is True, "CUT195 wave3 overlap")
    ...
    req(len(all_blocks) == 255 and len(set(all_blocks)) == 255, "wave4 block population drift")
    ...
    body = {
        ...
        "surface": "full178-cut",
        "node": "CUT196",
        "status": "WAVE4_CANDIDATE_AUDIT_REQUIRED",
        "source": {
            "cut195_pr": 1792,
            "cut195_audited_exact_head": "2618f4dcd546d569b212753ac7abc10e07ee5828",
            "cut195_exact_head_ci": 34664320955,
            "cut195_hostile_audit_review": 5184909672,
            "cut195_audited_candidate_pruned_terminals": CUT195_AUDITED_CANDIDATE,
        ...
        "target": {
            ...
            "survivor_offset_range": [766, 1020],
            "block_count": 255,
        ...
        "result": {
            ...
            "candidate_post_wave4_from_main_v12_terminals": MAIN_V12_TERMINALS - candidate,
            "candidate_post_cut193_cut194_cut195_cut196_from_main_v12_terminals": MAIN_V12_TERMINALS - CUT193_AUDITED_CANDIDATE - CUT194_AUDITED_CANDIDATE - CUT195_AUDITED_CANDIDATE - candidate,
