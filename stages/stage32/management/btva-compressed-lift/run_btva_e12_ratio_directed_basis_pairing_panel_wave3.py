...
SELECTOR=ROOT/"stages/stage32/management/btva-compressed-lift/BTVA-D8-E12-RATIO-DIRECTED-WAVE3-SELECTOR-RETAINED.json"
SELECTOR_BLOB="782e0198a34eda7f13949b83a6ac7fe0ea3b7f6d"
...
def main()->None:
    ...
    req(sel["hypothetical_if_all_selected_unsat"]["additional_tightening_beyond_wave2"]==14270,"selector impact drift")
    ...
    out={
      "schema":"STAGE32_MAIN_BTVA_D8_E12_RATIO_DIRECTED_BASIS_PAIRING_PANEL_WAVE3_V1",
      "stage":32,
      "status":"EXACT_RATIO_DIRECTED_WAVE3_PANEL_COMPLETE_ZERO_CREDIT" if kc==0 else "BOUNDED_RATIO_DIRECTED_WAVE3_PANEL_WITH_UNKNOWN_ZERO_CREDIT",
