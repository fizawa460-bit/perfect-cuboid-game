...
SELECTOR=ROOT/"stages/stage32/management/btva-compressed-lift/BTVA-D8-E12-RATIO-DIRECTED-WAVE2-SELECTOR-RETAINED.json"
SELECTOR_BLOB="a44c00caf11bd0b72d22cbef0a11098a333ce8d5"
...
def main()->None:
    ...
    req(len(keys)==16 and len(set(keys))==16,"selector key count")
    req(sel["hypothetical_if_all_selected_unsat"]["additional_tightening_beyond_wave1"]==5655,"selector impact drift")
    ...
    out={
      "schema":"STAGE32_MAIN_BTVA_D8_E12_RATIO_DIRECTED_BASIS_PAIRING_PANEL_WAVE2_V1",
      "stage":32,
      "status":"EXACT_RATIO_DIRECTED_WAVE2_PANEL_COMPLETE_ZERO_CREDIT" if kc==0 else "BOUNDED_RATIO_DIRECTED_WAVE2_PANEL_WITH_UNKNOWN_ZERO_CREDIT",
      "target":{"row_id":"g0-d008","g":0,"d":8,"e":12,"selected_count":16,"selected_base4_in_order":[list(k) for k in keys]},
      ...
      "rows":rows,
      "summary":{"unsat_base4_count":uc,"compatible_sat_base4_count":sc,"unknown_base4_count":kc,"all_selected_unsat":uc==16,"max_lazy_flat_cut_count":max(r["lazy_flat_cut_count"] for r in rows)},
