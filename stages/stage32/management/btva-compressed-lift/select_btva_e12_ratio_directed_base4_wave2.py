...
def main() -> None:
    ...
    req(sum(sum(v.values()) for v in proved_caps.values())==705870,"proved32 overlap replay")
    ...
    req(base_floor==444329,"post-wave1 exact qbin floor replay")
    ...
    out={
      "schema":"STAGE32_MAIN_BTVA_D8_E12_RATIO_DIRECTED_SELECTOR_WAVE2_V1",
      "stage":32,
      "status":"EXACT_HPADJ21_RATIO_DIRECTED_BTVA_WAVE2_SELECTOR_ZERO_CREDIT",
      "target":{"row_id":ROW_ID,"row_index":ROW_INDEX,"g":G,"d":D,"e":E,"selected_count":SELECT_COUNT},
      "baseline":{"top16_and_wave1_already_unsat":True,"proved_base4_count":32,"wave1_exact_qbin_row_floor":base_floor,"wave1_row_tightening_candidate":4102},
      ...
      "hypothetical_if_all_selected_unsat":{
        ...
        "additional_tightening_beyond_wave1":base_floor-current_floor,
      ...
      "population":{"e12_base4_key_count":len(raw_blocks),"hpadj21_predomain_base4_key_count":len(pre_caps_by_key),"proved_key_count":32},
      "source_locks":{
        ...
        "top16_key_stream_sha256":TOP16_SHA256,"wave1_retained_blob_sha1":WAVE1_RETAINED_BLOB,"wave1_retained_canonical_sha256":WAVE1_RETAINED_CANON,
      },
      "semantics":{
