...
SELECTOR=ROOT/"stages/stage32/management/btva-compressed-lift/BTVA-D8-E12-RATIO-DIRECTED-SELECTOR-RETAINED.json"
SELECTOR_BLOB="6a8a73d1bca01d0ef9f34b089254e7a98a5e44e0"
...
def main()->None:
    ...
    req(sel["hypothetical_if_all_selected_unsat"]["additional_tightening_beyond_top16"]==3932,"selector impact drift")
    ...
    out={
      "schema":"STAGE32_MAIN_BTVA_D8_E12_RATIO_DIRECTED_BASIS_PAIRING_PANEL_V1",
      "stage":32,
      "status":"EXACT_RATIO_DIRECTED_PANEL_COMPLETE_ZERO_CREDIT" if kc==0 else "BOUNDED_RATIO_DIRECTED_PANEL_WITH_UNKNOWN_ZERO_CREDIT",
