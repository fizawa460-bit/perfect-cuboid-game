...
def main() -> None:
    ...
    req(handoff["next_gate"] == "stage32-01-178-audit", "N372 retained handoff next gate drift")
    ...
    print(json.dumps({"verdict":"PASS_V20_EXTERNAL_SOURCE_LOCKS","audited_main_v19_exact_head":V19_HEAD,"n372_candidate_exact_head":N372_HEAD,"n372_hostile_audit_review_recorded_by_main_sync":N372_REVIEW,"n372_current_v15_witness_candidate_only":True,"n372_current_authority_rebase_required":True,"authority_unchanged":True,"merge_authorized":False}, sort_keys=True))
