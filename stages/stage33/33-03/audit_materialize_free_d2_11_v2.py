...
the cc-generator value.  The V1 hostile-audit verifier interpreted the labels
literally and therefore rejected valid H1 representatives before reaching the
transgression calculation.  This adapter corrects only that convention and
executes the otherwise unchanged direct verifier.
"""
