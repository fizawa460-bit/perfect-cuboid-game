...
required=["explicit_galois_action_certified","upic_gersten_maps_certified","kernels_cokernels_torsion_exact","unit_kernel_absolute_galois_inflation_character_terms_exact","no_unjustified_two_primary_restriction","qbar_to_q_descent_adapter_certified","open_algebraic_q_defined_class_inventory_complete","br0b_all_primary_classes_accounted"]
...
print(json.dumps({"success":True,"UNIT_STATUS":"AUDIT_REQUIRED","closure_criteria_satisfied":"10/11","BR0B":"DISCHARGED","next_expected_command":"Stage33-audit","certificate_sha256":h["canonical_sha256"]},indent=2,sort_keys=True))
