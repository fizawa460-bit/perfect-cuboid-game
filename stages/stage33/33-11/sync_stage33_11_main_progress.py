...
s11["status"] = "RUNNING_MAIN_5_OF_26_AUDIT_DEBT"
...
for b in s11.get("branches", []):
    if b.get("id") == "33-11c":
        b["main_status"] = "RUNNING_MAIN_5_OF_26_SMALLEST_RAW_ORDER2_WORKING_AUDIT_DEBT"
...
c["current_item"] = "Stage33-11_ARITHMETIC_LOCALIZATION_CONNECTING_MAP_RUNNING_MAIN_5_OF_26"
c["audit_required"] = True
c["merge_allowed"] = False
c["advance_allowed"] = True
c["advance_scope"] = "STAGE33_11_MAIN_CONTINUE_REMAINING_21_MIXED_ORDER_BLOCKS_WITH_SMALLEST_FIVE_AUDIT_DEBT"
c["next_item"] = "Stage33-11c_REMAINING_21_MIXED_ORDER_BLOCK_ORBIT_PRODUCTION"
...
checkpoint["stage33_11_next_branch"] = "33-11c_REMAINING_21_MIXED_ORDER_BLOCK_ORBIT_PRODUCTION"
