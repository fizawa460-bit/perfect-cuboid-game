#!/usr/bin/env python3
"""Exhaust one shard of the four-orbit pure-geometric k=3 full-Q[4] census."""
import hashlib
import json
import os
...
if manifest.get('orbit_count') != 4 or manifest.get('representative_section_count') != 12582912:
...
for record in manifest['records']:
    ...
    if len(free_variables(reduced)) != dimension:
...
certificate = {
    'schema': 'STAGE33_07_NONELEMENTARY_K3_GEOMETRIC_Q4_SHARD_V1',
    'manifest_sha256': manifest['canonical_sha256'],
    'arithmetic_generators_used': [],
    'shard_index': shard_index,
    'shard_count': shard_count,
    'coverage_rule': 'free_mask mod shard_count == shard_index independently in each of four orbit fibres',
    'records': records_out,
    ...
    'canonical_augmentation_used': False,
...
out = HERE / f'nonelementary-k3-geometric-q4-shard-{shard_index}.json'
