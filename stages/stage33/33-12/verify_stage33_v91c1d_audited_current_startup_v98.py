#!/usr/bin/env python3
"""Verify hostile-audited/merged V91C1D as current Stage33 MAIN authority."""
...
STATE_SHA="07805326657173a91204aedc680469b35f32fcf49215f300888f6b3dad7f8701"; V1D_SHA="fafb639197f12b0570c9f63526a0020c8a543417043dc316f386c037f5938e14"
...
p=s["audit_provenance"]; assert p=={"audit_pass_credit":True,"exact_audited_head":"1c76c3164681f225c42905067ee0d7d6c4a17418","hostile_audit_review":5123292911,"hostile_audit_verdict":"PASS","merge_commit":"cf5389b857ee52225ed44543ff7ac8d05387583a","merged_after_hostile_pass":True,"v91c1d_pr":1634}
...
print(json.dumps({"success":True,"marker":"V98_V91C1D_HOSTILE_AUDITED_MERGED_STARTUP","state_sha256":STATE_SHA,"v91c1d_sha256":V1D_SHA,"authority":"V91C1D_HOSTILE_AUDITED_MERGED","next_exact_leaf":NEXT},sort_keys=True))
