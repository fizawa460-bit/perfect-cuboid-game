...
## New exact reduction: full Galois fixedness also cannot mark J2

The previous Galois rejection used only `ct: sqrt(2)->-sqrt(2)`. The remaining generator `cc: i->-i` can now be evaluated directly in the semantic PicK frame.
