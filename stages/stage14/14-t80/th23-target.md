...
Merged tH22 gives `f_fin(chi)=(d)` and `N f_fin=d^2`. t80 then gives the exact affine projective Fourier expansion
...
Create dedicated `stages/stage14/14-tH23/`, literature note where useful, deterministic audit/frozen boundary, dedicated CI, and PR.