...
In particular every `delta>0` stratum is strict sub-square-root. Any sequence saturating the current square-root bound must therefore lie in cells with
