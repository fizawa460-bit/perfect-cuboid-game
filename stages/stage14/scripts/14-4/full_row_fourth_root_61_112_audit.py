...
# Nested-core row/column regression: J is strictly smaller than the full
# Cayley-good core. Column information is taken only on J, while the row CRT
# uses all of C_y after M is known. No product J*C_y is formed.
...
assert forced_root == F(3, 112)
assert forced_root == a
...
# Exact rational whole-strip audit of the post-cancellation envelopes.
D = 2240  # divisible by 16 and 224; contains the 61/224 equality point.
target = F(61, 112)
bestA = (F(-1), None)
bestB = (F(-1), None)
