...
cyclotomic branches, full signed allocation of agreement support, and the
merged s7-25 top-theta quotient exponent ledger.  Finite fiber histograms are
...
def audit_pair(a: dict[str, int], b: dict[str, int]):
    ...
    return key, S * T, (xi_dom, k_dom), (xi_quad, k_quad)
