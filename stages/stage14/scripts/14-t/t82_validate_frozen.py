...
frozen=json.loads((stage14/'data/14-t82/fixed_u_selector_divisor_frozen.json').read_text())
out=json.loads(subprocess.check_output(['python',str(stage14/'scripts/14-t/t82_fixed_u_selector_divisor_audit.py')],text=True))
