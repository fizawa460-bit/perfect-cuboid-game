...
Stage14-4cz consumes merged `Stage14-4cy`, merged `Stage14-s7-40`, and the exact root-gcd placement of merged `Stage14-s7-37`, on latest main through merged `Stage14-t78`.
...
The open/parallel fixed-U `t78/tH22` projective ray-character work is a different coefficient space and is not cross-promoted.
